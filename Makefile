...
# homeassistant.io/homeassistant-operator-bundle:$VERSION and homeassistant.io/homeassistant-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= homeassistant.io/homeassistant-operator
